...
\begin{enumerate}
\item 3D лидар, \fixme{изображённый на Рисунке };
\item 2D лидар \fixme{изображённый на Рисунке }.
\end{enumerate} 

Первый позволяет получить 3D картинку. Обычно такой лидар оснащён подвижным лазером, который довольно долго сканирует перед собой окружающую местность. \fixme{цитату где говорится о таком поведении лидара} Примером результата такой работы может стать картинка, \fixme{изображённая на Рисунке }.
...
Для того чтобы робот двигался ему необходимо шасси. Шасси в основной своей массе по своей подвижной части подразделяются на те, что осуществляют езду при помощи гусеничной ленты (пример \fixme{изображён на Рисунке }) и те, что ездят на колёсах (пример \fixme{изображён на рисунке }). Шасси на гусеницах обладают большей проходимостью и мобильностью в следствии того, что гусеницы позволяют, например, разворачивать робота на месте.
